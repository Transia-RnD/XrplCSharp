...
namespace Ripple.Binary.Codec.Types
{
    public class StReader
    {
        ...
        /// <summary> read field as <see cref="Ripple.Binary.Codec.Types.AccountId"/> from this parser </summary>
        public AccountId ReadAccountId() => AccountId.FromParser(_parser);

        /// <summary> read field as <see cref="Ripple.Binary.Codec.Types.Amount"/> from this parser </summary>
        public Amount ReadAmount() => Amount.FromParser(_parser);

        /// <summary> read field as <see cref="Ripple.Binary.Codec.Types.Blob"/> from this parser </summary>
        ...
        /// <summary> read field as <see cref="Ripple.Binary.Codec.Types.Currency"/> from this parser </summary>
        public Currency ReadCurrency() => Currency.FromParser(_parser);

        /// <summary> read field as <see cref="Ripple.Binary.Codec.Types.Hash128"/> from this parser </summary>
        public Hash128 ReadHash128() => Hash128.FromParser(_parser);

        /// <summary> read field as <see cref="Ripple.Binary.Codec.Types.Hash160"/> from this parser </summary>
        public Hash160 ReadHash160() => Hash160.FromParser(_parser);

        /// <summary> read field as <see cref="Ripple.Binary.Codec.Types.Hash256"/> from this parser </summary>
        public Hash256 ReadHash256() => Hash256.FromParser(_parser);
        /// <summary>
        /// Read Hash Prefix
        /// </summary>
        /// <returns><see cref="Ripple.Binary.Codec.Hashing.HashPrefix"/> prefix type</returns>
        ...
        /// <summary> read field as <see cref="Ripple.Binary.Codec.Types.PathSet"/> from this parser </summary>
        public PathSet ReadPathSet() => PathSet.FromParser(_parser);

        /// <summary> read field as <see cref="Ripple.Binary.Codec.Types.StArray"/> from this parser </summary>
        public StArray ReadStArray() => StArray.FromParser(_parser);

        /// <summary> read field as <see cref="Ripple.Binary.Codec.Types.StObject"/> from this parser </summary>
        public StObject ReadStObject() => StObject.FromParser(_parser);

        /// <summary> read field as <see cref="Ripple.Binary.Codec.Types.Uint16"/> from this parser </summary>
        public Uint16 ReadUint16() => Uint16.FromParser(_parser);

        /// <summary> read field as <see cref="Ripple.Binary.Codec.Types.Uint32"/> from this parser </summary>
        public Uint32 ReadUint32() => Uint32.FromParser(_parser);

        /// <summary> read field as <see cref="Ripple.Binary.Codec.Types.Uint64"/> from this parser </summary>
        public Uint64 ReadUint64() => Uint64.FromParser(_parser);

        /// <summary> read field as <see cref="Ripple.Binary.Codec.Types.Uint8"/> from this parser </summary>
        public Uint8 ReadUint8() => Uint8.FromParser(_parser);

        /// <summary> read field as <see cref="Ripple.Binary.Codec.Types.Vector256"/> from this parser </summary>
