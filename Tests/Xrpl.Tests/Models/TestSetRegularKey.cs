...
namespace XrplTests.Xrpl.Models
{
    ...
    public class TestUSetRegularKey
    {
        ...
        public async Task TestVerifyValid()
        {
            ...
            await Assert.ThrowsExceptionAsync<ValidationError>(() => Validation.ValidateSetRegularKey(account), "SetRegularKey: RegularKey must be a string");
            await Assert.ThrowsExceptionAsync<ValidationError>(() => Validation.Validate(account), "SetRegularKey: RegularKey must be a string");
