...
using Xrpl.Tests.Address.Codec.Tests.Properties;
...
namespace Xrpl.AddressCodecLib.Tests
{
    ...
    public class TestUAddressCodec
    {
        ...
        public void InvalidXAddressF()
        {
            ...
            //var _testCases = Encoding.ASCII.GetString(Resources.TestCases);
        ...
        public void ConvertTagFalse()
        {
            ...
            //Assert.IsFalse(myClassicAddress.Tag);
            Assert.AreEqual(myClassicAddress.Tag, -1);
        }
    }
}